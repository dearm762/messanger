...
import SetName from './routes/components/SetName';
import SetAva from './routes/SetAva';
...
const App = () => {
	...
	return (
		<Routes>
			...
			<Route path='/settings/name' element={ <SetName token={ token } setToken={ setToken } /> } />
			<Route path='/settings/avatar' element={ <SetAva token={ token } setToken={ setToken } /> } />
			<Route path='/chat/:id' element={ <Chat token={ token } setToken={ setToken } /> } />
			<Route path='/user/:id' element={ <User token={ token } setToken={ setToken } /> } />
